<div class="well well-sm">
	<ul class="nav nav-pills nav-stacked">
	  ...
	  <?php if($user->canViewApps($user->data()->id)){ ?><li<?php if($mod_page == 'banappeal'){ ?> class="active"<?php } ?>><a href="/mod/banappeal"><?php echo $banappeal_language['ban_appeal']; ?></a></li><?php } ?>
	</ul>
</div>